            ...
            <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        ...
                        <Link to="/">
                            <div className='font-bold  cursor-pointer flex flex-col '>
                                <p className='font-cinzel  text-sm  md:text-base  lg:text-4xl'>WristCrafters</p>
                                <p className='font-cinzel text-[5px] pl-3  md:text-[10px] lg:text-sm'>Craftsmanship in Every Second</p>
                            </div>
                        </Link>
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 WristCrafters. All rights reserved.</div>
            </footer>
